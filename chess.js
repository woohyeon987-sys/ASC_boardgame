...
const CARD_LIBRARY = [
    { id: 1, name: "소드마스터", cost: 10, hp: 15, atk: 8, range: 3, move: 2, icon: "🗡️" },
    { id: 2, name: "전사", cost: 2, hp: 12, atk: 3, range: 1, move: 1, icon: "⚔️" },
    { id: 3, name: "마법사", cost: 4, hp: 10, atk: 5, range: 3, move: 2, icon: "🧙‍♂️" },
    { id: 4, name: "대포", cost: 5, hp: 20, atk: 7, range: 4, move: 0, icon: "💣" },
    { id: 5, name: "궁수", cost: 3, hp: 10, atk: 3, range: 3, move: 3, icon: "🏹" },
    { id: 6, name: "투석기", cost: 4, hp: 4, atk: 4, range: 4, move: 1, icon: "🤾‍♀️" },
    { id: 7, name: "암살자", cost: 3, hp: 3, atk: 4, range: 1, move: 4, icon: "🥷" },
    { id: 8, name: "사령술사", cost: 8, hp: 8, atk: 4, range: 2, move: 2, icon: "☠️" },
    { id: 9, name: "골렘", cost: 6, hp: 50, atk: 2, range: 1, move: 1, icon: "🪨" },
    { id: 11, name: "폭탄", cost: 6, hp: 16, atk: 6, range: 2, move: 1, icon: "🧨" },
    { id: 13, name: "창", cost: 6, hp: 18, atk: 4, range: 2, move: 2, icon: "🔱" },
    { id: 14, name: "드래곤", cost: 15, hp: 15, atk: 7, range: 1, move: 3, icon: "🐲" },
    { id: 15, name: "드루이드", cost: 6, hp: 20, atk: 3, range: 2, move: 2, icon: "🌿" }
];
